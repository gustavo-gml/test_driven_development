...
public class Usuario {
    ...
    // Atributos novos  para o controle de segurança
    private int tentativas;
    private boolean bloqueado;

    // Construtor completo com todas as validações 
    public Usuario(String nome, String email, String cpf, String senha, LocalDate dataNascimento) throws IllegalArgumentException {
        ...
        // 3. Validações de formato e limites
        ...
        // Inicialização dos novos campos do Tiago
        this.tentativas = 0;
    ...
    // MÉTODOS DE CONTROLE DE LOGIN E BLOQUEIO Tiago
